...
$job->submitJob($_POST['tito'],$_POST['skills'],$_POST['price'],$_POST['time'],$_POST['description'],'none');
				...
				<div class="header-data">
					...
					<div class="user-account">
						<div class="user-info">
							...
							<a href="<?php echo $userLoggedIn;?>" title=""><?php echo $user['first_name'];?></a>
									...
									<div class="user-data full-width">
										<div class="user-profile">
											...
											<div class="user-specs">
												<a href="<?php echo $userLoggedIn;?>"><h3><?php echo $user['username'];?></h3></a>
										...
										<ul class="user-fw-status">
											...
											<li>
												<h4>Jobs</h4>
												<span><?php echo $user['num_jobs'];?></span>
											</li>
											<li>
												<h4>Projects</h4>
												<span><?php echo $user['num_projects'];?></span>
											</li>
											...
											<div class="profiles-slider">
												<div class="user-profy">
													...
													<ul>
														...
														<li><a href="#" title="" class="envlp"><img src="assets/images/envelop.png" alt=""></a></li>
									...
									<div class="posts-section">
										<div class="post-bar">
											...
											<div class="job-status-bar">
												...
												<a><i class="fa fa-eye"></i>Views 50</a>
											</div>
										</div><!--post-bar end-->
						...
						<div class="row">
							...
							<div class="col-lg-12">
								<ul>
									...
									<li><button class="active"  data-dismiss="modal" value="cancel">Cancel</button></li>
						...
						<div class="row">
							<div class="col-lg-12">
								<div class="inp-field">
									...
									<select name="tito" style="overflow: hidden;">
										<option value="">Select Job Title</option>
										<?php

										$skill= new Title($con);
										$know=$skill->getTitlee();
							...
							<div class="inp-field">
								<input type="text" name="skills" placeholder="Html,Css,java,Javascript,php,react,nodejs,mysql,flutter,android,ios,">
							</div>
							...
							<div class="col-lg-6">
								<div class="price-br">
									<input type="text" name="price" placeholder="Price e.g 20shs">
									<i class="fa fa-dollar"></i>
								</div>
							</div>
							<div class="col-lg-6">
							...
							<div class="col-lg-12">
								<ul>
									<li><button class="active" name="post-job" type="submit" value="post">Post</button></li>
